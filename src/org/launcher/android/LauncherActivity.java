...
public class LauncherActivity extends SDLActivity {
    ...
    public static LauncherActivity mActivity = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.v(TAG, "LauncherActivity onCreate running");
    ...
    public static void _do_start_service(
        ...
        Intent serviceIntent = new Intent(LauncherActivity.mActivity, PythonService.class);
        String argument = LauncherActivity.mActivity.getFilesDir().getAbsolutePath();
        String app_root_dir = LauncherActivity.mActivity.getAppRoot();
        String entry_point = LauncherActivity.mActivity.getEntryPoint(app_root_dir + "/service");
        ...
        LauncherActivity.mActivity.startService(serviceIntent);
    }

    public static void stop_service() {
        Intent serviceIntent = new Intent(LauncherActivity.mActivity, PythonService.class);
        LauncherActivity.mActivity.stopService(serviceIntent);
    }
    ...
    public void considerLoadingScreenRemoval() {
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                if (((LauncherActivity)LauncherActivity.mSingleton).mAppConfirmedActive &&
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    LauncherActivity activity =
                                        ((LauncherActivity)LauncherActivity.mSingleton);
                                    if (activity != null)
    ...
    protected View getLoadingScreen() {
        ...
        try {
            ...
            try {
                ...
                } else if (LauncherActivity.mLottieView.getParent() == null) {
